---
description: "godon Bench Scenarios — available benchmark scenarios for interference detection, covering linear to deeply nonlinear coupling channels."
---
...
When adding a bench, update this page with the scenario's properties and detection status.

### Further Reading

- [Interference Detection](concept_interference_detection.md) — methodology, channel taxonomy, and detection pipeline
